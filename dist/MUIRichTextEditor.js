...
var MUIRichTextEditor = function (props, ref) {
    ...
    var _j = (0, react_1.useState)([]), autocompleteItems = _j[0], setAutocompleteItems = _j[1];
    var _k = (0, react_1.useState)(function () { return useEditorState(props); }), editorState = _k[0], setEditorState = _k[1];
    var _l = (0, react_1.useState)(""), focusMediaKey = _l[0], setFocusMediaKey = _l[1];
    ...
    (0, react_1.useEffect)(function () {
        ...
        else if (((_a = autocompleteRef.current) === null || _a === void 0 ? void 0 : _a.asyncItems) !== undefined) {
            (_b = autocompleteRef.current) === null || _b === void 0 ? void 0 : _b.asyncItems(searchTerm).then(function (items) { return setAutocompleteItems(items); });
        }
    }, [searchTerm]);
    ...
    var getAutocompleteItems = function () {
        ...
        if (((_a = autocompleteRef.current) === null || _a === void 0 ? void 0 : _a.items) !== undefined) {
